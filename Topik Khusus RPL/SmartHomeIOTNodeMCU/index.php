...
<!--  -->
  <center>
    ...
    <button type="button" class="tambah btn" href="#" style="background:#2E8B57; color:white;"data-toggle="modal"data-target="#tambahOutput"><i class="fa fa-plus"></i> Tambahkan Perangkat</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">MENAMBAHKAN PERANGKAT BARU</h5>
      ...
      <form action="index.php" method="post">
         <div class="modal-body">
              <div class="form-group">
                  <input class="form-control" name="DEVICE" type="text" autocomplete="off" placeholder="Nama Perangkat"><br>
