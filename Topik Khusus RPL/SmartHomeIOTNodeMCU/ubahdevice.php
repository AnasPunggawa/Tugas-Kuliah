...
<body>
    ...
    <div class="card mt-4" style="width: 25rem;">
      <div class="card-body">
        <h5 class="card-title">UBAH DATA PERANGKAT</h5>
          <form action="ubahdevice.php" method="post">
                    <div class="form-group">
                      <input type="text" name="ID"  class="form-control" value="<?=$data["ID"];?>" hidden ><br>
                      <input type="text" name="DEVICE"  class="form-control" placeholder="Nama Perangkat" autocomplete="off" value="<?=$data["DEVICE"];?>" ><br>
